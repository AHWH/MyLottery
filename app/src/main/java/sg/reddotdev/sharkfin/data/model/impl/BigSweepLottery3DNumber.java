...
public class BigSweepLottery3DNumber extends LotteryNumber {
    public BigSweepLottery3DNumber() {
    }

    public BigSweepLottery3DNumber(int num, int lotteryID, ZonedDateTime date, int type) {
