...
public class BigSweepLottery5DNumber extends LotteryNumber {
    public BigSweepLottery5DNumber() {
    }

    public BigSweepLottery5DNumber(int num, int lotteryID, ZonedDateTime date, int type) {
