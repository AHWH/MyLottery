...
public class FourDLotteryNumber extends LotteryNumber {
    public FourDLotteryNumber() {
    }

    public FourDLotteryNumber(int num, int lotteryID, ZonedDateTime date, int type) {
